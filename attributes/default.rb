...
default['cb_vra_iaas']['asset_root'] = 'https://s3-ap-southeast-2.amazonaws.com/jpboycechefassets/'
...
# IIS Features List
default['cb_vra_iaas']['iis_features']['2016'] = %w(Web-Windows-Auth Web-Static-Content Web-Default-Doc Web-Asp-Net Web-Asp-Net45 Web-ISAPI-Ext Web-ISAPI-Filter WAS-Config-APIs WAS-NET-Environment WAS-Process-Model NET-WCF-HTTP-Activation45 NET-HTTP-Activation NET-Non-HTTP-Activ Web-Mgmt-Tools )
default['cb_vra_iaas']['iis_features']['2012r2'] = %w(Web-Windows-Auth Web-Static-Content Web-Default-Doc Web-Asp-Net Web-Asp-Net45 Web-ISAPI-Ext Web-ISAPI-Filter WAS-Config-APIs WAS-NET-Environment WAS-Process-Model NET-WCF-HTTP-Activation45 NET-HTTP-Activation NET-Non-HTTP-Activ Web-Mgmt-Tools )
...
default['cb_vra_iaas']['java']['source'] = "#{node['cb_vra_iaas']['asset_root']}jre-8u191-windows-x64.exe"
...
default['cb_vra_iaas']['dotnet']['source'] = "#{node['cb_vra_iaas']['asset_root']}NDP452-KB2901907-x86-x64-AllOS-ENU.exe"
